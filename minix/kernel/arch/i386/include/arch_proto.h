...
void reload_ds(void);
void ia32_msr_read(uint32_t reg, uint32_t * hi, uint32_t * lo);
void ia32_msr_write(uint32_t reg, uint32_t hi, uint32_t lo);
void fninit(void);
void clts(void);
void fxsave(void *);
void fnsave(void *);
...
void x86_lgdt(void *);
void x86_lldt(uint32_t);
void x86_ltr(uint32_t);
void x86_lidt(void *);
void x86_load_kerncs(void);
void x86_load_ds(uint32_t);
void x86_load_ss(uint32_t);
void x86_load_es(uint32_t);
void x86_load_fs(uint32_t);
void x86_load_gs(uint32_t);
